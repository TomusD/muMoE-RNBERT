...
This repository contains the official implementation of the model described in the ICASSP 2026 [paper](https://drive.google.com/file/d/1AxEq5o17pqSM4ofU_voqHWCGsIwECavb/view?usp=sharing) **"Interpretable Music Harmonic Analysis Through Multilinear Mixture of Experts"**.
...
```
And also my thesis, if you find it useful, which has a bit more information about the project and some ablation studies:
